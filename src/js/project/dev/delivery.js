...
define(['backbone', 'config', './framework/deliveryAssignmentList',
	...
	var DeliveryRouter = Backbone.Router.extend({
		initialize:function(){
			 ...
			 */
			self.listenTo(carInfoModel, "confirmed", function(){
				//顯示出車相關資訊
			...
			*/
			 ...
			 */
			self.listenTo(departureModel, "departure.confirmed departure.loginOnly", function(){
